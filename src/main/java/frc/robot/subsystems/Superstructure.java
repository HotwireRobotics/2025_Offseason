...
public class Superstructure extends SubsystemBase {
	...
	public boolean LVL3Processes() {
		if (intake.hasCoral()) {
			if (
				arm.isArmAtPosition(Constants.ArmPositions.LVL3, Rotations.of(0.04))
			) {
	...
	public boolean LVL2Processes() {
		if (intake.hasCoral()) {
			if (
				arm.isArmAtPosition(Constants.ArmPositions.LVL2, Rotations.of(0.035)) &&
				arm.isWristAtPosition(Constants.WristPositions.LVL2, Rotations.of(0.035))
			) {
				System.out.println("Arm is in position");
