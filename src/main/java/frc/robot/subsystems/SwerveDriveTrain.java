...
public class SwerveDriveTrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    public Command pathfind(Pose2d pose, PathConstraints constraints) {
        ...
        PathPlannerPath path = new PathPlannerPath(waypoints, Constants.constraints, null, 
    ...
    public Command navigate() {
        ...
        switch (targetState) {
            ...
            case NAVIGATE_EXIT_LVL2:
                ...
                command = pathfind(nearestPose, Constants.constraints).andThen(new InstantCommand(() -> {
                    GO_HOME = true;
                }));
                break;
            default:
